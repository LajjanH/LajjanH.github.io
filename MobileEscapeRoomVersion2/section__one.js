...
const textElement1 = indexSvg3.querySelector("text");
const textElement2 = indexSvg.querySelector("text");
const textElement3 = indexSvg1.querySelector("text");
const textElement4 = indexSvg2.querySelector("text");
textElement1.style.fill = "#ffffff";
...
indexBtn.addEventListener("click", () => {
  ...
  if (indexBtn.classList.contains("colorBtn1")) {
    ...
    indexSvg.style.zIndex = "4";
    textElement1.style.fill = "#757575";
    textElement2.style.fill = "#ffffff";
    console.log("1");
  }
  ...
  if (indexBtn.classList.contains("colorBtn2")) {
    ...
    indexSvg1.style.zIndex = "4";
    textElement2.style.fill = "#757575";
    textElement3.style.fill = "#ffffff";
    console.log("2");
  }
  ...
  if (indexBtn.classList.contains("colorBtn3")) {
    ...
    indexSvg2.style.zIndex = "4";
    textElement3.style.fill = "#757575";
    textElement4.style.fill = "#ffffff";
    console.log("3");
  }
  ...
  if (indexBtn.classList.contains("colorBtn4")) {
    ...
    indexSvg3.style.zIndex = "4";
    textElement4.style.fill = "#757575";
    textElement1.style.fill = "#ffffff";
    console.log("4");
  }
});
