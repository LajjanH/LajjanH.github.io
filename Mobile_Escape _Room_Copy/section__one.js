...
svgText.addEventListener("touchmove", (e) => {
  if (active) {
    ...
    answer.style.transform = `rotateS(${rotationAngle1}deg)`;
...
function addSafariClass() {
  if (isSafari) {
    svg.classList.add("svg-iphone");
    indexSvg.classList.add("svg-iphone");
    indexSvg1.classList.add("svg-iphone");
    indexSvg2.classList.add("svg-iphone");
    indexSvg3.classList.add("svg-iphone");
  }
}
